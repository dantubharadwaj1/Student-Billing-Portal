...
PreparedStatement ps=con.prepareStatement("select * from student2 where firstname like '"+n+"%'");
//ps.setString(1,n);
out.print("<br>");
ResultSet rs=ps.executeQuery();
out.print("<table border='5' cellspacing=5 cellpadding=2 id='myTable'>");
out.print("<tr><td><a href='#' name='ID' onmouseover='javascript:getGenInfo(this.name)'><B>ID</B></a></td><td><B>Name</B></td><td><B>Last Name</B></td></tr>");
while(rs.next()){
