...
<table>
<tr><td><font style="color: navy;">Find Accountant :-</font></td><td><input type="text" align="right" name="findName" onkeyup="sendInfo()"></input></td></tr></table>
